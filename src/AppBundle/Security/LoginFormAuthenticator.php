...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    {
        $isLoginSubmit = ($request->getPathInfo() == '/login/user' || $request->getPathInfo() == '/login/manager' || $request->getPathInfo() == '/login/admin' )  && $request->isMethod('POST');
        // $isGrowerLoginSubmit = $request->getPathInfo()=='/login/grower' && $request->isMethod('POST');

        if($request->getPathInfo() == '/login/user'){
            $this->role = '["ROLE_USER"]';
        }elseif($request->getPathInfo() == '/login/manager') {
